...
const btnScreenSize = document.querySelector(".j-btn-screenSize");
btnScreenSize.addEventListener("click", () => {
    alert("Ширина Вашего экрана: " + document.documentElement.clientWidth + ", высота: " + document.documentElement.clientHeight)
});